...
extern bool m_d_nucleus(complex double *c, complex double c_guess, int period, int maxsteps);
extern bool m_d_wucleus(complex double *z, complex double *dz, complex double z_guess, complex double c, int period, int maxsteps);
extern bool m_d_interior(complex double *z, complex double *c, complex double z_guess, complex double c_guess, complex double interior, int period, int maxsteps);
extern bool m_d_parent(mpq_t angle, complex double *root, complex double *parent, complex double nucleus, int period, int maxsteps);
...
extern m_d_exray_in *m_d_exray_in_new(const mpq_t angle);
extern void m_d_exray_in_delete(m_d_exray_in *ray);
extern bool m_d_exray_in_step(m_d_exray_in *ray);
...
extern m_d_exray_out *m_d_exray_out_new(const mpq_t angle);
extern void m_d_exray_out_delete(m_d_exray_out *ray);
extern bool m_d_exray_out_step(m_d_exray_out *ray);
